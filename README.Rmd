...
* Recent versions of the V8 package do not compile on Alpine Linux by default.
  On x86_64 you can install an older version, if you set and environment
  variable that switches to a static V8 library:
  ```
