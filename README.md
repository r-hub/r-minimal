...
|-----------|---------------|-------------------------------------------------------------------|-------------|
| R devel   | 4.6.0-devel   | `devel`, `4.6.0`, `4.6`, `4.6.0-devel`, `4.6-devel`, `2025-11-17` | Built daily |
| R next    | 4.5.2-Patched | `next`, `patched`, `4.5.2-patched`, `4.5-patched`                 | Built daily |
| R release | 4.5.2         | `4.5.2`, `4.5`, `release`, `latest`                               |             |
