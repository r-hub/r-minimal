...
|-----------|-------------|-------------------------------------------------------------------|-------------|
| R devel   | 4.7.0-devel | `devel`, `4.7.0`, `4.7`, `4.7.0-devel`, `4.7-devel`, `2026-03-30` | Built daily |
| R next    | 4.6.0-alpha | `next`, `4.6.0`, `4.6`, `alpha`, `4.6.0-alpha`, `4.6-alpha`       | Built daily |
| R release | 4.5.3       | `4.5.3`, `4.5`, `release`, `latest`                               |             |
