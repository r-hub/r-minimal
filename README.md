...
|-----------|---------------|-------------------------------------------------------------------|-------------|
| R devel   | 4.7.0-devel   | `devel`, `4.7.0`, `4.7`, `4.7.0-devel`, `4.7-devel`, `2026-05-24` | Built daily |
| R next    | 4.6.0-Patched | `next`, `patched`, `4.6.0-patched`, `4.6-patched`                 | Built daily |
| R release | 4.6.0         | `4.6.0`, `4.6`, `release`, `latest`                               |             |
