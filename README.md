...
|-----------|---------------|-------------------------------------------------------------------|-------------|
| R devel   | 4.5.0-devel   | `devel`, `4.5.0`, `4.5`, `4.5.0-devel`, `4.5-devel`, `2025-03-03` | Built daily |
| R next    | 4.4.3-Patched | `next`, `patched`, `4.4.3-patched`, `4.4-patched`                 | Built daily |
