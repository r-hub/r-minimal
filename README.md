...
|-----------|---------------|-------------------------------------------------------------------|-------------|
| R devel   | 4.6.0-devel   | `devel`, `4.6.0`, `4.6`, `4.6.0-devel`, `4.6-devel`, `2026-03-14` | Built daily |
| R next    | 4.5.3-Patched | `next`, `patched`, `4.5.3-patched`, `4.5-patched`                 | Built daily |
